...
class PluginSecurityManager {
	...
	// Restricted packages
	private val restrictedPackages =
		setOf(
			"sun.",
			"com.sun.",
			"jdk.internal.",
	...
	private fun hasRequiredPermissionForClass(
		className: String,
		permissions: Set<PluginPermission>,
	): Boolean =
		when (className) {
